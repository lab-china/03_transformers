...
--overwrite_output
'''
basedir='D:/00_work/77_src/trainxlnet'
data_dir="D:/00_work/77_src/99_swagaf/data"
model_type="xlnet"
task_name="swag"
model_name_or_path=basedir+'/model_dir/model.ckpt-3000'
model_name_or_path="xlnet-base-cased"#basedir+'/xlnet_cased_L-12_H-768_A-12/xlnet_model.ckpt'
do_train=True
do_eval=True
do_lower_case=True
output_dir=basedir+"/04_swag"
def main():
    ...
    parser.add_argument(
        "--do_lower_case", default=do_lower_case,action="store_true", help="Set this flag if you are using an uncased model."
    )
